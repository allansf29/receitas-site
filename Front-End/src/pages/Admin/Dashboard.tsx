        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link to="/admin/recipes" className="block">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Gerenciar Receitas</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">Edite, remova ou adicione receitas existentes.</p>
            </motion.div>
          </Link>
          ...
          <Link to="/admin/add" className="block">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Adicionar Receita</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">Crie novas receitas para o site.</p>
            </motion.div>
          </Link>
          ...
          <Link to="/" className="block">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Voltar ao Site</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">Veja como os usuários enxergam o conteúdo.</p>
            </motion.div>
          </Link>
        </div>
      </main>
