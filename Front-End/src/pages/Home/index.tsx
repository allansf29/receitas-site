          ...
          {selectedRecipe && (
            <div className="p-6 overflow-y-auto max-h-[80vh]">
              ...
              <button
                ...
                className="mt-4 inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-red-500 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-detail-dark dark:hover:bg-red-800 dark:focus:ring-red-800 cursor-pointer"
              >
                Fechar
              </button>
            </div>
